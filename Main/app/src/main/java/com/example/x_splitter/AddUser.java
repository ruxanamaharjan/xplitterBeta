...
import static com.example.x_splitter.LoginActivity.currentAppUserEmail;
...
public class AddUser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SelectUserName.addTextChangedListener(new TextWatcher() {
            @Override
...
//        });
    ...
    private void searchUsers(String user){
        ...
        FirebaseRecyclerOptions<AddUserModel> options =
                new FirebaseRecyclerOptions.Builder<AddUserModel>().setQuery(searchUserQuery, AddUserModel.class).build();
